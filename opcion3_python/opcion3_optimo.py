...
try:
    # Lee la matriz de 20x20 que asume estar en la clave "D"
    DATA = json.load(open(RUTA_RAIZ / "distances.json"))["D"]
except FileNotFoundError:
    print("ERROR: No hay 'distances.json' en Colab")
    raise


def sub(n):
    """Extrae la submatriz de tamaño n x n de la matriz original."""
...
if __name__ == "__main__":
    resultados = {}
    print("== Calculando Óptimos con Held-Karp ==")
